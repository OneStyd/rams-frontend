                    ...
                    <div class="card-header">
                        <div class="card-body">
                            <h4>Download seluruh leger</h4>
                                <form action="{{ route('admin.leger.jembatan.print-all') }}" method="POST" target="_blank">
                                    @csrf
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.leger.jembatan.print') }}" method="POST" target="_blank">
                                @csrf
                        ...
                        <div class="card-body">
                            <div id="admin-map" data-route="{{ route('admin.leger.jembatan.print') }}"></div>
                        </div>
                    </div>
                </div>
            </div>
